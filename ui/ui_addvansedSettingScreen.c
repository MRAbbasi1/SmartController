...
lv_obj_set_y( ui_AdvancedScreenContainer6, 45 );
...
lv_obj_set_style_text_font(ui_search_sensor_setup_Button_Label, &lv_font_montserrat_14, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_y( ui_submit_factory, 25 );
