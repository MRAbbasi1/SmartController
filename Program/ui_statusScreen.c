...
lv_obj_t *ui_statusScreen = NULL;lv_obj_t *ui_returnButton3 = NULL;lv_obj_t *ui_statusscreenlabel = NULL;lv_obj_t *ui_TEMP_Label = NULL;lv_obj_t *ui_ALARM_Label = NULL;lv_obj_t *ui_Status_Label = NULL;lv_obj_t *ui_App_Connection_Label = NULL;lv_obj_t *ui_info_Label = NULL;lv_obj_t *ui_Maintenance_Label = NULL;lv_obj_t *ui_tempStatusButton = NULL;lv_obj_t *ui_tempStatusPanel = NULL;lv_obj_t *ui_returnButton11 = NULL;lv_obj_t *ui_tempStatusLabel = NULL;lv_obj_t *ui_inlet_temp_danger = NULL;lv_obj_t *ui_outlet_temp_danger = NULL;lv_obj_t *ui_antifreeze_temp_danger = NULL;lv_obj_t *ui_filter_temp_danger = NULL;lv_obj_t *ui_ContainerA1 = NULL;lv_obj_t *ui_Inlet_Temp_status = NULL;lv_obj_t *ui_Outlet_Temp_status = NULL;lv_obj_t *ui_antifreeze_temp_status = NULL;lv_obj_t *ui_fan_2_filter_alarm_status = NULL;lv_obj_t *ui_alarmStatusButton = NULL;lv_obj_t *ui_alarmStatusPanel = NULL;lv_obj_t *ui_returnButton2 = NULL;lv_obj_t *ui_alarmStatusLabel = NULL;lv_obj_t *ui_high_temp_danger = NULL;lv_obj_t *ui_door_danger = NULL;lv_obj_t *ui_filter_danger = NULL;lv_obj_t *ui_high_pressure_danger = NULL;lv_obj_t *ui_ContainerA2 = NULL;lv_obj_t *ui_high_Temp_Alarm = NULL;lv_obj_t *ui_Door_Alarm = NULL;lv_obj_t *ui_Filter_Alarm = NULL;lv_obj_t *ui_high_Pressure_Alarm = NULL;lv_obj_t *ui_relayStatusButton = NULL;lv_obj_t *ui_relayStatusPanel = NULL;lv_obj_t *ui_returnButton7 = NULL;lv_obj_t *ui_relayStatusLabel = NULL;lv_obj_t *ui_ContainerA3 = NULL;lv_obj_t *ui_evaprartor_Fan_Status = NULL;lv_obj_t *ui_Compressor_Status = NULL;lv_obj_t *ui_condensor_Fan_1_Status = NULL;lv_obj_t *ui_condensor_Fan_2_Status = NULL;lv_obj_t *ui_networkStatusButton = NULL;lv_obj_t *ui_networkStatusPanel = NULL;lv_obj_t *ui_returnButton8 = NULL;lv_obj_t *ui_Connect_to_Device_Label = NULL;lv_obj_t *ui_ContainerA4 = NULL;lv_obj_t *ui_access_Point_wifi = NULL;lv_obj_t *ui_access_Point_Password = NULL;lv_obj_t *ui_guidetext = NULL;lv_obj_t *ui_QRcode_Tab = NULL;lv_obj_t *ui_appldownload = NULL;lv_obj_t *ui_Application_QR_Code = NULL;lv_obj_t *ui_download_App_Label = NULL;lv_obj_t *ui_connectToapp = NULL;lv_obj_t *ui_Connection_QR_Code = NULL;lv_obj_t *ui_Connect_App_Label = NULL;lv_obj_t *ui_show_QR_Code_Button = NULL;lv_obj_t *ui_Hide_QR_Code_Button = NULL;lv_obj_t *ui_deviceInfoButton = NULL;lv_obj_t *ui_deviceInfoPanel = NULL;lv_obj_t *ui_returnButton9 = NULL;lv_obj_t *ui_deviceInfoLabel = NULL;lv_obj_t *ui_ContainerA5 = NULL;lv_obj_t *ui_serial_number = NULL;lv_obj_t *ui_customerID = NULL;lv_obj_t *ui_activationDate = NULL;lv_obj_t *ui_serviceInfoButton = NULL;lv_obj_t *ui_serviceInfoPanel = NULL;lv_obj_t *ui_returnButton10 = NULL;lv_obj_t *ui_serviceInfoLabel = NULL;lv_obj_t *ui_ContainerA6 = NULL;lv_obj_t *ui_servicesintervals = NULL;
// event funtions
...
lv_obj_set_style_bg_img_src( ui_statusScreen, &ui_img_4413586_480x480_png, LV_PART_MAIN | LV_STATE_DEFAULT );

ui_returnButton3 = lv_btn_create(ui_statusScreen);
lv_obj_set_width( ui_returnButton3, 80);
lv_obj_set_height( ui_returnButton3, 50);
lv_obj_set_x( ui_returnButton3, -195 );
lv_obj_set_y( ui_returnButton3, -210 );
...
lv_obj_set_style_radius(ui_returnButton3, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_y( ui_statusscreenlabel, -210 );
lv_obj_set_align( ui_statusscreenlabel, LV_ALIGN_CENTER );
lv_label_set_text(ui_statusscreenlabel,"INFORMATION");
lv_obj_set_style_text_color(ui_statusscreenlabel, lv_color_hex(0x080041), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_statusscreenlabel, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_statusscreenlabel, &lv_font_montserrat_24, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_x( ui_TEMP_Label, -155 );
lv_obj_set_y( ui_TEMP_Label, -10 );
lv_obj_set_align( ui_TEMP_Label, LV_ALIGN_CENTER );
lv_label_set_text(ui_TEMP_Label,"Temperature");
lv_obj_set_style_text_color(ui_TEMP_Label, lv_color_hex(0x080041), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_text_color(ui_ALARM_Label, lv_color_hex(0x080041), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_ALARM_Label, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_ALARM_Label, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_x( ui_Status_Label, 155 );
lv_obj_set_y( ui_Status_Label, -10 );
lv_obj_set_align( ui_Status_Label, LV_ALIGN_CENTER );
lv_label_set_text(ui_Status_Label,"Status");
lv_obj_set_style_text_color(ui_Status_Label, lv_color_hex(0x080041), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_Status_Label, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_Status_Label, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_x( ui_App_Connection_Label, -155 );
lv_obj_set_y( ui_App_Connection_Label, 150 );
lv_obj_set_align( ui_App_Connection_Label, LV_ALIGN_CENTER );
lv_label_set_text(ui_App_Connection_Label,"Connection");
lv_obj_set_style_text_color(ui_App_Connection_Label, lv_color_hex(0x080041), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_App_Connection_Label, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_App_Connection_Label, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_x( ui_info_Label, 155 );
lv_obj_set_y( ui_info_Label, 150 );
lv_obj_set_align( ui_info_Label, LV_ALIGN_CENTER );
lv_label_set_text(ui_info_Label,"About");
lv_obj_set_style_text_color(ui_info_Label, lv_color_hex(0x080041), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_info_Label, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_info_Label, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_y( ui_Maintenance_Label, 150 );
lv_obj_set_align( ui_Maintenance_Label, LV_ALIGN_CENTER );
lv_label_set_text(ui_Maintenance_Label,"Maintenance");
lv_obj_set_style_text_color(ui_Maintenance_Label, lv_color_hex(0x080041), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_text_opa(ui_Maintenance_Label, 255, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_text_font(ui_Maintenance_Label, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_tempStatusButton = lv_btn_create(ui_statusScreen);
lv_obj_set_width( ui_tempStatusButton, 100);
lv_obj_set_height( ui_tempStatusButton, 100);
lv_obj_set_x( ui_tempStatusButton, -155 );
lv_obj_set_y( ui_tempStatusButton, -80 );
...
lv_obj_set_width( ui_tempStatusPanel, 485);
lv_obj_set_height( ui_tempStatusPanel, 485);
...
lv_obj_set_style_bg_grad_color(ui_tempStatusPanel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_grad_dir(ui_tempStatusPanel, LV_GRAD_DIR_VER, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_width( ui_returnButton11, 80);
lv_obj_set_height( ui_returnButton11, 50);
lv_obj_set_x( ui_returnButton11, -195 );
lv_obj_set_y( ui_returnButton11, -210 );
...
lv_obj_set_style_radius(ui_returnButton11, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_y( ui_tempStatusLabel, -210 );
...
lv_obj_set_style_text_font(ui_tempStatusLabel, &lv_font_montserrat_24, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_x( ui_inlet_temp_danger, 215 );
lv_obj_set_y( ui_inlet_temp_danger, -130 );
...
lv_obj_set_x( ui_outlet_temp_danger, 215 );
lv_obj_set_y( ui_outlet_temp_danger, -35 );
...
lv_obj_set_x( ui_antifreeze_temp_danger, 215 );
lv_obj_set_y( ui_antifreeze_temp_danger, 55 );
...
lv_obj_set_x( ui_filter_temp_danger, 215 );
lv_obj_set_y( ui_filter_temp_danger, 145 );
...
lv_obj_set_width( ui_ContainerA1, 440);
lv_obj_set_height( ui_ContainerA1, 300);
...
lv_obj_set_style_text_font(ui_Inlet_Temp_status, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_Outlet_Temp_status, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_antifreeze_temp_status, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_fan_2_filter_alarm_status, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_alarmStatusButton = lv_btn_create(ui_statusScreen);
lv_obj_set_width( ui_alarmStatusButton, 100);
lv_obj_set_height( ui_alarmStatusButton, 100);
lv_obj_set_x( ui_alarmStatusButton, 0 );
lv_obj_set_y( ui_alarmStatusButton, -80 );
...
lv_obj_set_width( ui_alarmStatusPanel, 485);
lv_obj_set_height( ui_alarmStatusPanel, 485);
...
lv_obj_set_style_bg_grad_color(ui_alarmStatusPanel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_grad_dir(ui_alarmStatusPanel, LV_GRAD_DIR_VER, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_width( ui_returnButton2, 80);
lv_obj_set_height( ui_returnButton2, 50);
lv_obj_set_x( ui_returnButton2, -195 );
lv_obj_set_y( ui_returnButton2, -210 );
...
lv_obj_set_style_radius(ui_returnButton2, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_y( ui_alarmStatusLabel, -210 );
...
lv_obj_set_style_text_font(ui_alarmStatusLabel, &lv_font_montserrat_24, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_x( ui_high_temp_danger, 215 );
lv_obj_set_y( ui_high_temp_danger, -130 );
...
lv_obj_set_x( ui_door_danger, 215 );
lv_obj_set_y( ui_door_danger, -35 );
...
lv_obj_set_x( ui_filter_danger, 215 );
lv_obj_set_y( ui_filter_danger, 55 );
...
lv_obj_set_x( ui_high_pressure_danger, 215 );
lv_obj_set_y( ui_high_pressure_danger, 150 );
...
lv_obj_set_width( ui_ContainerA2, 440);
lv_obj_set_height( ui_ContainerA2, 300);
...
lv_obj_set_style_text_font(ui_high_Temp_Alarm, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_Door_Alarm, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_Filter_Alarm, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_high_Pressure_Alarm, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_relayStatusButton = lv_btn_create(ui_statusScreen);
lv_obj_set_width( ui_relayStatusButton, 100);
lv_obj_set_height( ui_relayStatusButton, 100);
lv_obj_set_x( ui_relayStatusButton, 155 );
lv_obj_set_y( ui_relayStatusButton, -80 );
...
lv_obj_set_width( ui_relayStatusPanel, 485);
lv_obj_set_height( ui_relayStatusPanel, 485);
...
lv_obj_set_style_bg_grad_color(ui_relayStatusPanel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_grad_dir(ui_relayStatusPanel, LV_GRAD_DIR_VER, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_width( ui_returnButton7, 80);
lv_obj_set_height( ui_returnButton7, 50);
lv_obj_set_x( ui_returnButton7, -195 );
lv_obj_set_y( ui_returnButton7, -210 );
...
lv_obj_set_style_radius(ui_returnButton7, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_y( ui_relayStatusLabel, -210 );
...
lv_obj_set_style_text_font(ui_relayStatusLabel, &lv_font_montserrat_24, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_ContainerA3 = lv_obj_create(ui_relayStatusPanel);
lv_obj_remove_style_all(ui_ContainerA3);
lv_obj_set_width( ui_ContainerA3, 440);
lv_obj_set_height( ui_ContainerA3, 300);
...
lv_obj_set_style_text_font(ui_evaprartor_Fan_Status, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_Compressor_Status, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_condensor_Fan_1_Status, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_condensor_Fan_2_Status, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_networkStatusButton = lv_btn_create(ui_statusScreen);
lv_obj_set_width( ui_networkStatusButton, 100);
lv_obj_set_height( ui_networkStatusButton, 100);
lv_obj_set_x( ui_networkStatusButton, -155 );
lv_obj_set_y( ui_networkStatusButton, 80 );
...
lv_obj_set_width( ui_networkStatusPanel, 485);
lv_obj_set_height( ui_networkStatusPanel, 485);
...
lv_obj_set_style_bg_grad_color(ui_networkStatusPanel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_grad_dir(ui_networkStatusPanel, LV_GRAD_DIR_VER, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_width( ui_returnButton8, 80);
lv_obj_set_height( ui_returnButton8, 50);
lv_obj_set_x( ui_returnButton8, -195 );
lv_obj_set_y( ui_returnButton8, -210 );
...
lv_obj_set_style_radius(ui_returnButton8, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_y( ui_Connect_to_Device_Label, -210 );
...
lv_obj_set_style_text_font(ui_Connect_to_Device_Label, &lv_font_montserrat_24, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_ContainerA4 = lv_obj_create(ui_networkStatusPanel);
lv_obj_remove_style_all(ui_ContainerA4);
lv_obj_set_width( ui_ContainerA4, 440);
lv_obj_set_height( ui_ContainerA4, 400);
lv_obj_set_x( ui_ContainerA4, 0 );
lv_obj_set_y( ui_ContainerA4, 25 );
...
lv_obj_set_style_text_font(ui_access_Point_wifi, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_access_Point_Password, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_color(ui_guidetext, lv_color_hex(0xDDDDDD), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_text_font(ui_guidetext, &lv_font_montserrat_16, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_QRcode_Tab = lv_tabview_create(ui_networkStatusPanel, LV_DIR_BOTTOM, 50);
lv_obj_set_width( ui_QRcode_Tab, 440);
lv_obj_set_height( ui_QRcode_Tab, 380);
...
lv_obj_set_style_radius(ui_QRcode_Tab, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(lv_tabview_get_tab_btns(ui_QRcode_Tab), &lv_font_montserrat_18,  LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_border_width(lv_tabview_get_tab_btns(ui_QRcode_Tab), 3,  LV_PART_ITEMS| LV_STATE_DEFAULT);
...
lv_obj_set_style_outline_width(lv_tabview_get_tab_btns(ui_QRcode_Tab), 2,  LV_PART_ITEMS| LV_STATE_DEFAULT);
lv_obj_set_style_outline_pad(lv_tabview_get_tab_btns(ui_QRcode_Tab), 2,  LV_PART_ITEMS| LV_STATE_DEFAULT);
...
lv_obj_set_style_radius(ui_appldownload, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_width( ui_Application_QR_Code, 200);
lv_obj_set_height( ui_Application_QR_Code, 200);
...
lv_obj_set_x( ui_download_App_Label, 126 );
lv_obj_set_y( ui_download_App_Label, -71 );
...
lv_obj_set_style_text_font(ui_download_App_Label, &lv_font_montserrat_18, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_radius(ui_connectToapp, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_width( ui_Connection_QR_Code, 200);
lv_obj_set_height( ui_Connection_QR_Code, 200);
...
lv_obj_set_style_text_font(ui_Connect_App_Label, &lv_font_montserrat_18, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_show_QR_Code_Button = lv_btn_create(ui_networkStatusPanel);
lv_obj_set_width( ui_show_QR_Code_Button, 80);
lv_obj_set_height( ui_show_QR_Code_Button, 50);
lv_obj_set_x( ui_show_QR_Code_Button, 195 );
lv_obj_set_y( ui_show_QR_Code_Button, -210 );
...
lv_obj_set_style_radius(ui_show_QR_Code_Button, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_width( ui_Hide_QR_Code_Button, 80);
lv_obj_set_height( ui_Hide_QR_Code_Button, 50);
lv_obj_set_x( ui_Hide_QR_Code_Button, 195 );
lv_obj_set_y( ui_Hide_QR_Code_Button, -210 );
...
lv_obj_set_style_radius(ui_Hide_QR_Code_Button, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_width( ui_deviceInfoButton, 100);
lv_obj_set_height( ui_deviceInfoButton, 100);
lv_obj_set_x( ui_deviceInfoButton, 155 );
lv_obj_set_y( ui_deviceInfoButton, 80 );
...
lv_obj_set_width( ui_deviceInfoPanel, 485);
lv_obj_set_height( ui_deviceInfoPanel, 485);
...
lv_obj_set_style_bg_grad_color(ui_deviceInfoPanel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_grad_dir(ui_deviceInfoPanel, LV_GRAD_DIR_VER, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_width( ui_returnButton9, 80);
lv_obj_set_height( ui_returnButton9, 50);
lv_obj_set_x( ui_returnButton9, -195 );
lv_obj_set_y( ui_returnButton9, -210 );
...
lv_obj_set_style_radius(ui_returnButton9, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_y( ui_deviceInfoLabel, -210 );
...
lv_obj_set_style_text_font(ui_deviceInfoLabel, &lv_font_montserrat_24, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_ContainerA5 = lv_obj_create(ui_deviceInfoPanel);
lv_obj_remove_style_all(ui_ContainerA5);
lv_obj_set_width( ui_ContainerA5, 440);
lv_obj_set_height( ui_ContainerA5, 300);
...
lv_obj_set_style_text_font(ui_serial_number, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_customerID, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_activationDate, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_serviceInfoButton = lv_btn_create(ui_statusScreen);
lv_obj_set_width( ui_serviceInfoButton, 100);
lv_obj_set_height( ui_serviceInfoButton, 100);
lv_obj_set_x( ui_serviceInfoButton, 0 );
lv_obj_set_y( ui_serviceInfoButton, 80 );
...
lv_obj_set_width( ui_serviceInfoPanel, 485);
lv_obj_set_height( ui_serviceInfoPanel, 485);
...
lv_obj_set_style_bg_grad_color(ui_serviceInfoPanel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
lv_obj_set_style_bg_grad_dir(ui_serviceInfoPanel, LV_GRAD_DIR_VER, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_width( ui_returnButton10, 80);
lv_obj_set_height( ui_returnButton10, 50);
lv_obj_set_x( ui_returnButton10, -195 );
lv_obj_set_y( ui_returnButton10, -210 );
...
lv_obj_set_style_radius(ui_returnButton10, 10, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_y( ui_serviceInfoLabel, -210 );
...
lv_obj_set_style_text_font(ui_serviceInfoLabel, &lv_font_montserrat_24, LV_PART_MAIN| LV_STATE_DEFAULT);

ui_ContainerA6 = lv_obj_create(ui_serviceInfoPanel);
lv_obj_remove_style_all(ui_ContainerA6);
lv_obj_set_width( ui_ContainerA6, 440);
lv_obj_set_height( ui_ContainerA6, 300);
...
lv_obj_set_style_text_font(ui_servicesintervals, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
uic_statusScreen= NULL;
ui_statusScreen= NULL;
uic_returnButton3= NULL;
ui_returnButton3= NULL;
uic_statusscreenlabel= NULL;
ui_statusscreenlabel= NULL;
uic_TEMP_Label= NULL;
ui_TEMP_Label= NULL;
uic_ALARM_Label= NULL;
ui_ALARM_Label= NULL;
uic_Status_Label= NULL;
ui_Status_Label= NULL;
uic_App_Connection_Label= NULL;
ui_App_Connection_Label= NULL;
uic_info_Label= NULL;
ui_info_Label= NULL;
uic_Maintenance_Label= NULL;
ui_Maintenance_Label= NULL;
uic_tempStatusButton= NULL;
ui_tempStatusButton= NULL;
uic_tempStatusPanel= NULL;
ui_tempStatusPanel= NULL;
uic_returnButton11= NULL;
ui_returnButton11= NULL;
uic_tempStatusLabel= NULL;
ui_tempStatusLabel= NULL;
uic_inlet_temp_danger= NULL;
ui_inlet_temp_danger= NULL;
uic_outlet_temp_danger= NULL;
ui_outlet_temp_danger= NULL;
uic_antifreeze_temp_danger= NULL;
ui_antifreeze_temp_danger= NULL;
uic_filter_temp_danger= NULL;
ui_filter_temp_danger= NULL;
uic_ContainerA1= NULL;
ui_ContainerA1= NULL;
uic_Inlet_Temp_status= NULL;
ui_Inlet_Temp_status= NULL;
uic_Outlet_Temp_status= NULL;
ui_Outlet_Temp_status= NULL;
uic_antifreeze_temp_status= NULL;
ui_antifreeze_temp_status= NULL;
uic_fan_2_filter_alarm_status= NULL;
ui_fan_2_filter_alarm_status= NULL;
uic_alarmStatusButton= NULL;
ui_alarmStatusButton= NULL;
uic_alarmStatusPanel= NULL;
ui_alarmStatusPanel= NULL;
uic_returnButton2= NULL;
ui_returnButton2= NULL;
uic_alarmStatusLabel= NULL;
ui_alarmStatusLabel= NULL;
uic_high_temp_danger= NULL;
ui_high_temp_danger= NULL;
uic_door_danger= NULL;
ui_door_danger= NULL;
uic_filter_danger= NULL;
ui_filter_danger= NULL;
uic_high_pressure_danger= NULL;
ui_high_pressure_danger= NULL;
uic_ContainerA2= NULL;
ui_ContainerA2= NULL;
uic_high_Temp_Alarm= NULL;
ui_high_Temp_Alarm= NULL;
uic_Door_Alarm= NULL;
ui_Door_Alarm= NULL;
uic_Filter_Alarm= NULL;
ui_Filter_Alarm= NULL;
uic_high_Pressure_Alarm= NULL;
ui_high_Pressure_Alarm= NULL;
uic_relayStatusButton= NULL;
ui_relayStatusButton= NULL;
uic_relayStatusPanel= NULL;
ui_relayStatusPanel= NULL;
uic_returnButton7= NULL;
ui_returnButton7= NULL;
uic_relayStatusLabel= NULL;
ui_relayStatusLabel= NULL;
uic_ContainerA3= NULL;
ui_ContainerA3= NULL;
uic_evaprartor_Fan_Status= NULL;
ui_evaprartor_Fan_Status= NULL;
uic_Compressor_Status= NULL;
ui_Compressor_Status= NULL;
uic_condensor_Fan_1_Status= NULL;
ui_condensor_Fan_1_Status= NULL;
uic_condensor_Fan_2_Status= NULL;
ui_condensor_Fan_2_Status= NULL;
uic_networkStatusButton= NULL;
ui_networkStatusButton= NULL;
uic_networkStatusPanel= NULL;
ui_networkStatusPanel= NULL;
uic_returnButton8= NULL;
ui_returnButton8= NULL;
uic_Connect_to_Device_Label= NULL;
ui_Connect_to_Device_Label= NULL;
uic_ContainerA4= NULL;
ui_ContainerA4= NULL;
uic_access_Point_wifi= NULL;
ui_access_Point_wifi= NULL;
uic_access_Point_Password= NULL;
ui_access_Point_Password= NULL;
uic_guidetext= NULL;
ui_guidetext= NULL;
uic_QRcode_Tab= NULL;
ui_QRcode_Tab= NULL;
ui_appldownload= NULL;
uic_Application_QR_Code= NULL;
ui_Application_QR_Code= NULL;
uic_download_App_Label= NULL;
ui_download_App_Label= NULL;
uic_connectToapp= NULL;
ui_connectToapp= NULL;
uic_Connection_QR_Code= NULL;
ui_Connection_QR_Code= NULL;
uic_Connect_App_Label= NULL;
ui_Connect_App_Label= NULL;
uic_show_QR_Code_Button= NULL;
ui_show_QR_Code_Button= NULL;
uic_Hide_QR_Code_Button= NULL;
ui_Hide_QR_Code_Button= NULL;
uic_deviceInfoButton= NULL;
ui_deviceInfoButton= NULL;
uic_deviceInfoPanel= NULL;
ui_deviceInfoPanel= NULL;
uic_returnButton9= NULL;
ui_returnButton9= NULL;
uic_deviceInfoLabel= NULL;
ui_deviceInfoLabel= NULL;
uic_ContainerA5= NULL;
ui_ContainerA5= NULL;
uic_serial_number= NULL;
ui_serial_number= NULL;
uic_customerID= NULL;
ui_customerID= NULL;
uic_activationDate= NULL;
ui_activationDate= NULL;
uic_serviceInfoButton= NULL;
ui_serviceInfoButton= NULL;
uic_serviceInfoPanel= NULL;
ui_serviceInfoPanel= NULL;
uic_returnButton10= NULL;
ui_returnButton10= NULL;
uic_serviceInfoLabel= NULL;
ui_serviceInfoLabel= NULL;
uic_ContainerA6= NULL;
ui_ContainerA6= NULL;
uic_servicesintervals= NULL;
ui_servicesintervals= NULL;
